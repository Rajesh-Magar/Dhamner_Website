...
const projects = [
  ...
  {
    status: "ongoing",
    mr_title: "पाण्याची टाकी (इंदिरा नगर)",
    en_title: "Water Tank (Indira Nagar)",
    mr_desc: "इंदिरा नगर मध्ये पाण्याची टाकी बांधण्याचे काम सुरू आहे.",
    en_desc: "Construction of water tank started in Indira Nagar.",
    cost: "₹2,50,000",
    year: "2025-26",
    progress: 30,
