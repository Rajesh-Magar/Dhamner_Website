...
const localTexts = {
  mr: {
    ...
    heroDesc: "विवाह प्रमाणपत्रासाठी ऑनलाइन अर्ज करा",
  ...
  en: {
    ...
    heroDesc: "Apply online for Marriage Certificate",
...
export default function MarriageDocument() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" ? "http://localhost:5000" : "https://dhamner-website.onrender.com"}/api/marriage-form`, data);
